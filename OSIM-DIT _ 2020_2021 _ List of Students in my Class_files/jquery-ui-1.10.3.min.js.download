...
// a full solution for string manipulation and internationalization.
    ...
    var lastActive,
        baseClasses = "ui-button ui-widget btn btn-primary ui-state-default ui-corner-all",
        typeClasses = "ui-button-icons-only btn btn-primary ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only",
