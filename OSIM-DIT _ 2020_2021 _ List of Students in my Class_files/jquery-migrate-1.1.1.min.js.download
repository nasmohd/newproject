    ...
    function (e, t, n) {
        ...
        e.fn.andSelf = function () {
            ...
            e.clean || (e.clean = function (t, a, o, i) {
                ...
                }, s = 0; null != (u = d[s]); s++) e.nodeName(u, 'script') && c(u) || (o.appendChild(u), u.getElementsByTagName !== n && (l = e.grep(e.merge([], u.getElementsByTagName('script')), c), d.splice.apply(d, [
                    s + 1,
                    0
                ].concat(l)), s += l.length));
                return d
        ...
        e.event.props && 'attrChange' !== e.event.props[0] && e.event.props.unshift('attrChange', 'attrName', 'relatedNode', 'srcElement'),
            ...
            e.event.trigger = function (e, t, n, a) {
                return n || M.test(e) || r('Global events are undocumented and deprecated'),
